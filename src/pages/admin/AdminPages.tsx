...
const AdminPages = observer(() => {
  ...
  const currentPageSummary = pageType
    ? pageStore.getPageBySlug(pageType)
    : null;
    ...
    return (
      <div className="p-6">
        <div className="flex items-center justify-between">
          ...
          <button className="px-3 py-2 bg-primary-500 text-white font-semibold rounded-lg" onClick={() => navigate('/admin/pages/add')}>
            + Thêm trang mới
          </button>
        </div>
